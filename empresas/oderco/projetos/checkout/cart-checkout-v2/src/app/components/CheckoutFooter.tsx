    ...
    <footer className="w-full bg-card">
      ...
      <div className="border-t border-muted py-6 flex justify-center px-4">
        <div className="text-center">
          <p className="caption text-foreground mb-3" style={{ fontWeight: 'var(--font-weight-bold)' }}>Contato</p>
      ...
      {/* Marcas do grupo */}
      <div className="border-t border-muted flex justify-center py-5 px-4">
        <div className="text-center">
          <p className="caption text-foreground mb-3" style={{ fontWeight: 'var(--font-weight-bold)' }}>MARCAS DO GRUPO</p>
      ...
      <div className="border-t border-muted flex justify-center py-4 px-4">
        <div className="w-full max-w-[1120px] flex flex-col sm:flex-row items-center justify-center sm:justify-between gap-2">
          <p className="caption text-muted-foreground m-0 text-center sm:text-left">
