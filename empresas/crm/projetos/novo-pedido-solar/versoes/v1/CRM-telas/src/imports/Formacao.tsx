import svgPaths from "./svg-ck5vbjb35q";
...
import { imgFrame } from "./svg-o63nx";

function Group7() {
  return (
    <div className="absolute contents left-[103.52px] top-[253px]">
      <div className="absolute h-[73px] left-[103.52px] top-[253px] w-[74.263px]" data-name="image 2">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage2} />
      </div>
      <p className="absolute font-['Red_Hat_Display:Regular',sans-serif] font-normal leading-[normal] left-[calc(8.33%+74.06px)] text-[#4d5163] text-[12px] top-[273px] w-[442.526px] whitespace-pre-wrap">PLACA DE VIDEO NVIDIA GEFORCE GT740 GDD5 4GB 128BIT - PAX740D54GB</p>
      <p className="absolute font-['Red_Hat_Display:Regular',sans-serif] font-normal leading-[normal] left-[calc(8.33%+74.06px)] text-[#4d5163] text-[12px] top-[290px] w-[64.09px] whitespace-pre-wrap">SKU: 123123</p>
    </div>
  );
}
...
function Group8() {
  return (
    <div className="absolute contents left-[103.52px] top-[150px]">
      <div className="absolute content-stretch flex flex-col gap-[12px] items-start left-[103.52px] top-[150px] w-[817.91px]" data-name="input default">
...
function Group55() {
  return (
    <div className="absolute contents left-[73px] top-[131px]">
      <div className="absolute bg-white border border-[#e0e0e0] border-solid h-[303px] left-[73px] rounded-[8px] top-[131px] w-[882px]" />
      <Group7 />
      <Group8 />
      <div className="absolute bg-[#005aff] content-stretch flex gap-[16px] items-center justify-center left-[104px] px-[24px] py-[12px] rounded-[8px] top-[358px] w-[171px]" data-name="buttom">
...
function Search() {
  return (
    <div className="absolute left-[calc(58.33%+21px)] size-[24px] top-[195px]" data-name="search">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="search">
          <path d={svgPaths.p19568f00} id="Vector" stroke="var(--stroke-0, #005AFF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M21 21L16.65 16.65" id="Vector_2" stroke="var(--stroke-0, #005AFF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function Group63() {
  return (
    <div className="absolute contents left-[calc(58.33%-5px)] top-[264px]">
      <p className="absolute font-['Red_Hat_Display:Regular',sans-serif] font-normal leading-[normal] left-[calc(58.33%+25px)] text-[#101010] text-[16px] top-[264px]">ES</p>
      <button className="absolute block cursor-pointer left-[calc(58.33%-5px)] rounded-[25px] size-[18px] top-[266px]" data-name="select">
        <div aria-hidden="true" className="absolute border border-[#d7d8da] border-solid inset-0 pointer-events-none rounded-[25px]" />
      </button>
    </div>
  );
}
...
function Group64() {
  return (
    <div className="absolute contents left-[calc(58.33%-5px)] top-[297px]">
      <p className="absolute font-['Red_Hat_Display:Regular',sans-serif] font-normal leading-[normal] left-[calc(58.33%+25px)] text-[#101010] text-[16px] top-[297px]">PR</p>
      <button className="absolute block cursor-pointer left-[calc(58.33%-5px)] rounded-[25px] size-[18px] top-[299px]" data-name="select">
        <div aria-hidden="true" className="absolute border border-[#d7d8da] border-solid inset-0 pointer-events-none rounded-[25px]" />
      </button>
    </div>
  );
  ...
  return (
    <div className="absolute h-[94.184px] left-[113.94px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[23.055px_27.232px] mask-size-[47.283px_47.283px] top-[1676.77px] w-[90.055px]" data-name="Frame" style={{ maskImage: `url('${imgFrame}')` }}>
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 90.0554 94.184">
        <g clipPath="url(#clip0_1_1054)" id="Frame">
  ...
  return (
    <div className="absolute h-[131.719px] left-[69.45px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[67.549px_61.638px] mask-size-[47.283px_47.283px] top-[1354.36px] w-[125.945px]" data-name="Frame" style={{ maskImage: `url('${imgFrame}')` }}>
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 125.945 131.719">
        <g clipPath="url(#clip0_1_1104)" id="Frame">
  ...
  return (
    <div className="absolute h-[152px] left-[82.3px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[54.695px_104px] mask-size-[47.283px_47.283px] top-[1024px] w-[145.337px]" data-name="Frame" style={{ maskImage: `url('${imgFrame}')` }}>
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 145.337 152">
        <g clipPath="url(#clip0_1_1012)" id="Frame">
  ...
  return (
    <div className="absolute h-[98px] left-[calc(41.67%+49px)] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[47px_12px] mask-size-[47.283px_47.283px] top-[1116px] w-[94px]" data-name="Frame" style={{ maskImage: `url('${imgFrame}')` }}>
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 94 98">
        <g clipPath="url(#clip0_1_972)" id="Frame">
  ...
  return (
    <div className="absolute h-[70px] left-[calc(41.67%+93px)] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[3px_-3px] mask-size-[47.283px_47.283px] top-[1565px] w-[66.932px]" data-name="Frame" style={{ maskImage: `url('${imgFrame}')` }}>
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 66.9315 70">
        <g clipPath="url(#clip0_1_1144)" id="Frame">
...
function Group119() {
  return (
    <div className="absolute contents left-[79px] top-[1021px]">
      <div className="absolute bg-white border border-[#e0e0e0] border-solid h-[969px] left-[79px] rounded-[8px] top-[1021px] w-[1329px]" />
      <Group76 />
      <Group129 />
      <Group125 />
      <Group130 />
...
function Group43() {
  return (
    <div className="absolute contents font-['Red_Hat_Display:Regular',sans-serif] font-normal leading-[normal] left-[99px] text-[16px] top-[2086px]">
      ...
      <p className="-translate-x-full absolute left-[calc(41.67%+107px)] text-[#101010] text-right top-[2086px]">5 clientes</p>
    </div>
  );
}
...
function Group44() {
  return (
    <div className="absolute contents font-['Red_Hat_Display:Regular',sans-serif] font-normal leading-[normal] left-[99.04px] text-[16px] top-[2123px]">
      ...
      <p className="-translate-x-full absolute left-[calc(41.67%+107.95px)] text-[#101010] text-right top-[2123px]">5 clientes</p>
    </div>
  );
}
...
function Group45() {
  return (
    <div className="absolute contents font-['Red_Hat_Display:Regular',sans-serif] font-normal leading-[normal] left-[99.04px] text-[16px] top-[2160px]">
      ...
      <p className="-translate-x-full absolute left-[calc(41.67%+107.95px)] text-[#101010] text-right top-[2160px]">5 clientes</p>
    </div>
  );
}
...
function Group46() {
  return (
    <div className="absolute contents font-['Red_Hat_Display:Regular',sans-serif] font-normal leading-[normal] left-[99.04px] text-[16px] top-[2197px]">
      ...
      <p className="-translate-x-full absolute left-[calc(41.67%+107.95px)] text-[#101010] text-right top-[2197px]">5 clientes</p>
    </div>
  );
}
...
function Group47() {
  return (
    <div className="absolute contents font-['Red_Hat_Display:Regular',sans-serif] font-normal leading-[normal] left-[99.04px] text-[16px] top-[2234px]">
      ...
      <p className="-translate-x-full absolute left-[calc(41.67%+107.95px)] text-[#101010] text-right top-[2234px]">5 clientes</p>
    </div>
  );
}
...
function Group48() {
  return (
    <div className="absolute contents font-['Red_Hat_Display:Regular',sans-serif] font-normal leading-[normal] left-[99.04px] text-[16px] top-[2271px]">
      ...
      <p className="-translate-x-full absolute left-[calc(41.67%+107px)] text-[#101010] text-right top-[2271px]">5 clientes</p>
    </div>
  );
}
...
function Group49() {
  return (
    <div className="absolute contents font-['Red_Hat_Display:Regular',sans-serif] font-normal leading-[normal] left-[calc(50%+60.57px)] text-[#101010] text-[16px] top-[2086px]">
      ...
      <p className="-translate-x-full absolute left-[calc(91.67%+66.5px)] text-right top-[2086px] w-[83.496px] whitespace-pre-wrap">24/10/2022</p>
    </div>
  );
}
...
function Group50() {
  return (
    <div className="absolute contents font-['Red_Hat_Display:Regular',sans-serif] font-normal leading-[normal] left-[calc(50%+60.57px)] text-[#101010] text-[16px] top-[2123px]">
      ...
      <p className="-translate-x-full absolute left-[calc(91.67%+67.45px)] text-right top-[2123px] w-[83.496px] whitespace-pre-wrap">24/10/2022</p>
    </div>
  );
}
...
function Group51() {
  return (
    <div className="absolute contents font-['Red_Hat_Display:Regular',sans-serif] font-normal leading-[normal] left-[calc(50%+60.57px)] text-[#101010] text-[16px] top-[2160px]">
      ...
      <p className="-translate-x-full absolute left-[calc(91.67%+67.45px)] text-right top-[2160px] w-[83.496px] whitespace-pre-wrap">24/10/2022</p>
    </div>
  );
}
...
function Group52() {
  return (
    <div className="absolute contents font-['Red_Hat_Display:Regular',sans-serif] font-normal leading-[normal] left-[calc(50%+60.57px)] text-[#101010] text-[16px] top-[2197px]">
      ...
      <p className="-translate-x-full absolute left-[calc(91.67%+67.45px)] text-right top-[2197px] w-[83.496px] whitespace-pre-wrap">24/10/2022</p>
    </div>
  );
}
...
function Group53() {
  return (
    <div className="absolute contents font-['Red_Hat_Display:Regular',sans-serif] font-normal leading-[normal] left-[calc(50%+60.57px)] text-[#101010] text-[16px] top-[2234px]">
      ...
      <p className="-translate-x-full absolute left-[calc(91.67%+67.45px)] text-right top-[2234px] w-[83.496px] whitespace-pre-wrap">24/10/2022</p>
    </div>
  );
}
...
function Group54() {
  return (
    <div className="absolute contents font-['Red_Hat_Display:Regular',sans-serif] font-normal leading-[normal] left-[calc(50%+60.57px)] text-[#101010] text-[16px] top-[2271px]">
      ...
      <p className="-translate-x-full absolute left-[calc(91.67%+66.5px)] text-right top-[2271px] w-[83.496px] whitespace-pre-wrap">24/10/2022</p>
    </div>
  );
}
...
function Group138() {
  return (
    <div className="absolute left-[calc(83.33%+48px)] size-[116px] top-[191px]">
...
function Frame12() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] items-center left-[calc(66.67%+52px)] top-[201px]">
      <Frame7 />
      <Frame11 />
      <Frame8 />
      <Frame10 />
...
export default function Formacao() {
  return (
    <div className="bg-white relative size-full" data-name="formacao">
      ...
      <div className="absolute bg-white border border-[#e0e0e0] border-solid h-[303px] left-[calc(66.67%+27px)] rounded-[8px] top-[131px] w-[422px]" />
      <div className="absolute font-['Red_Hat_Display:Regular',sans-serif] font-normal h-[93px] leading-[0] left-[calc(66.67%+52px)] text-[#101010] text-[0px] top-[318px] w-[220px] whitespace-pre-wrap">
      ...
      <p className="absolute font-['Red_Hat_Display:Bold',sans-serif] font-bold leading-[normal] left-[calc(66.67%+52px)] text-[#101010] text-[20px] top-[153px]">Aging</p>
      <Group63 />
      <Group64 />
      <Group121 />
      <Group120 />
