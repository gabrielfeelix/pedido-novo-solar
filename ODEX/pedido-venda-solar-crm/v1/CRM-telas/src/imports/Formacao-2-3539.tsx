import svgPaths from "./svg-rnobh107vh";
...
import { imgFrame } from "./svg-wd7g6";
...
export default function Formacao() {
  return (
    <div className="bg-white relative size-full" data-name="formacao">
      ...
      <div className="absolute h-[303px] left-[calc(66.67%+27px)] top-[131px] w-[422px]">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 422 303">
          <path d={svgPaths.p1fd314c0} fill="var(--fill-0, white)" id="Rectangle 137" stroke="var(--stroke-0, #E0E0E0)" />
        </svg>
      </div>
      <Group63 />
      <Group64 />
