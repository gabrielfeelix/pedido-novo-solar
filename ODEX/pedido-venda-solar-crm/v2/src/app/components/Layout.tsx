...
const topNav: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Novo Orçamento Solar', description: 'Inicie e acompanhe o fluxo dedicado de orçamento solar', path: '/vendas/orcamentos-solar' },
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Campanhas', description: 'Cadastre regras comerciais e campanhas por marca', path: '/cadastros/campanhas' },
...
export function Layout() {
  ...
  const hideBreadcrumb =
    isDashboardRoute
    || location.pathname === '/vendas/novo-pedido-solar'
    || location.pathname === '/vendas/orcamentos-solar';
