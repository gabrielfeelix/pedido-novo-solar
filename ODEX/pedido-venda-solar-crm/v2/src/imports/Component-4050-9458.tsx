import svgPaths from "./svg-qmcnmheia5";

function Label() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute content-stretch flex flex-col gap-[2px] items-center justify-center left-1/2 top-1/2 w-[49px]" data-name="Label">
      <p className="font-['Geist:Semibold',sans-serif] leading-[30px] not-italic relative shrink-0 text-[#0a0a0a] text-[30px] tracking-[-1px]">1125</p>
      <p className="font-['Geist:Regular',sans-serif] font-normal leading-[16px] min-w-full relative shrink-0 text-[#737373] text-[12px] text-center w-[min-content] whitespace-pre-wrap">visitors</p>
    </div>
  );
}
...
export default function Component() {
  return (
    <div className="content-stretch flex gap-[64px] items-start pt-[64px] px-[64px] relative size-full" data-name="Component">
      <p className="font-['Geist:Semibold',sans-serif] leading-[28.8px] not-italic relative shrink-0 text-[#0a0a0a] text-[24px] tracking-[-1px] w-[320px] whitespace-pre-wrap">.Donut Chart Label</p>
      <DonutChart />
    </div>
  );
}